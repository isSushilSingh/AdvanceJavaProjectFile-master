...
import javax.swing.*;
public class exp20 extends javax.swing.JFrame {
    public exp20() {
        initComponents();
    }
    ...
    try
    {
        ...
        ResultSet rs;
        String query = "select*from exp20";
        ...
        Logger.getLogger(exp20.class.getName()).log(Level.SEVERE, null, ex);
    }
